...
namespace DapperLabs.Flow.Sdk
{
    ...
    public class Transactions
    {
        ...
        public static async Task<FlowTransactionResponse> Submit(string script, List<CadenceBase> arguments=null)
        {
            try
            {
                return await FlowSDK.GetWalletProvider().Mutate(script, arguments);
            }
			catch (Exception ex)
            {
		...
		internal static async Task<FlowTransactionResponse> InternalSubmit(string script, List<CadenceBase> arguments = null)
        {
            try
            {
