...
{
    internal class CadenceRepeatedTypeConverter : JsonConverter
    {
        private readonly Dictionary<string, CadenceTypeBase> _repeatedIds = new Dictionary<string, CadenceTypeBase>();        
        ...
        {
            if(value is CadenceTypeBase cadenceType)
            {
                string key = "";
                string typeId = "";
        ...
        private bool IsRepeatedType(string key, CadenceTypeBase cadenceType)
        {
