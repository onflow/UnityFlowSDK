...
flow transactions build ./transactions/transfer-flow-tokens.cdc 0xf3fcd2c1a78f5eee 1000.0 --authorizer emulator-account --proposer emulator-account --payer emulator-account --filter payload --save built.rlp -y
flow transactions sign ./built.rlp --signer emulator-account --filter payload --save signed.rlp -y
