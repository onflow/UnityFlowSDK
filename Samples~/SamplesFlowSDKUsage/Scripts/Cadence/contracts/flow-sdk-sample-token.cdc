...
pub contract FlowSDKSampleToken {
    ...
    pub resource VaultMinter {
        ...
        pub fun mintTokens(amount: UFix64, recipient: Capability<&AnyResource{Receiver}>) {
            ...
            FlowSDKSampleToken.totalSupply = FlowSDKSampleToken.totalSupply + UFix64(amount)
    ...
    init() {
        ...
        self.VaultStoragePath = /storage/FlowSDKSampleTokenVault
        self.VaultPublicPath = /public/FlowSDKSampleTokenVault
        self.MinterStoragePath = /storage/FlowSDKSampleTokenMinter
        ...
        self.account.link<&VaultMinter>(/private/Minter, target: self.MinterStoragePath)
    }
}
